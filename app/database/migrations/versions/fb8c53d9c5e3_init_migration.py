...
Revision ID: fb8c53d9c5e3
Revises: 
Create Date: 2025-05-04 19:35:54.254509
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_emotion_label_id_label'), 'emotion_label', ['id_label'], unique=False)
    ...
    sa.ForeignKeyConstraint(['label_id'], ['emotion_label.id_label'], ),
    ...
    sa.ForeignKeyConstraint(['label_id'], ['emotion_label.id_label'], ),
    sa.ForeignKeyConstraint(['predicted_label_id'], ['emotion_label.id_label'], ),
    ...
    sa.Column('id_label', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['id_label'], ['emotion_label.id_label'], ),
    ...
    sa.Column('automatic_emotion', sa.String(length=50), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table('model')
    op.drop_index(op.f('ix_emotion_label_id_label'), table_name='emotion_label')
    op.drop_table('emotion_label')
    # ### end Alembic commands ###
