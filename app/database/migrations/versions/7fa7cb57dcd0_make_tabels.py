...
Revision ID: 7fa7cb57dcd0
Revises: 
Create Date: 2025-05-04 14:28:05.941083
...
def downgrade() -> None:
    ...
    sa.Column('id_validation', sa.INTEGER(), autoincrement=True, nullable=False),
